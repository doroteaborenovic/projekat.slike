...
class SpectralDecomposeBlock(nn.Module):
    ...
    def __init__(self, channels: int):
        ...
        # POPRAVLJENO: Unapređena prostorno-kanalna kapija za novi model
    ...
    def forward(self, x: Tensor) -> Tensor:
        # POPRAVLJENO: Višeskalna dekompozicija (Piramidalno niskofrekventno filtriranje)
        low2 = F.interpolate(
        ...
        # Izračunavanje fine 2D kapije za lokalizovanu fuziju frekvencija
...
if __name__ == '__main__':
    putanja_do_modela = "/content/drive/MyDrive/Projekat_Model_Novi/dodinamreza_best.pth"
